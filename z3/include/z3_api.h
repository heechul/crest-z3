...
/**
   ...
   - \c Z3_config: a configuration object used to initialize logical contexts.
   - \c Z3_context: logical context. This is the main Z3 data-structure.
   - \c Z3_symbol: a Lisp-like symbol. It is used to name types, constants, and functions.  A symbol can be created using
   string or integers.
   - \c Z3_ast: abstract syntax tree node. That is, the data-structure used in Z3 to represent terms, formulas and types.
   - \c Z3_sort: a kind of AST used to represent types.
   - \c Z3_app: a kind of AST used to represent constant and function declarations.
   - \c Z3_pattern: a kind of AST used to represent pattern and multi-patterns used to guide quantifier instantiation.
   - \c Z3_model: a model for the constraints asserted into the logical context.
*/
...
/**
   \mlonly {!symbol} \endmlonly \conly \brief
...
/**
   ...
   - Z3_EXCEPTION:     Internal Z3 exception. Additional details can be retrieved using Z3_get_error_msg_ex.
*/
typedef enum
{
    Z3_OK,            
...
[pointer_default(ref)] interface Z3 {
    ...
    */
    ...
    /**
       ...
       \deprecated Use #Z3_mk_context_rc
    */
    ...
    */
    ...
    /**
       ...
       \sa Z3_set_param_value
    */
    Z3_bool Z3_API Z3_get_param_value(__in Z3_context c, __in Z3_string param_id, __out Z3_string_ptr param_value);
#endif
    ...
    */
    ...
    /**
       ...
       \mlonly \remark [Z3.sort_to_ast c s] can be replaced by [(s :> Z3.ast)]. \endmlonly
    */
    ...
    */
    ...
    /**
       \mlonly {4 {L Bitvectors}} \endmlonly
    */
    ...
    */
    ...
    /**
       \mlonly {4 {L Finite Domains}} \endmlonly
    */
    ...
    */
    ...
    /**
       \mlonly {4 {L Datatypes}} \endmlonly
    */
    ...
    */
    ...
    /**
       \mlonly {4 {L Relations}} \endmlonly
    */
    ...
    */
    ...
    /**
       ...
       \mlonly \remark [Z3.func_decl_to_ast c f]  can be replaced by [(f :> Z3.ast)]. \endmlonly
    */
    ...
    */
    ...
    /**
       ...
       \mlonly \remark [Z3.app_to_ast c a] can be replaced by [(a :> Z3.ast)]. \endmlonly
    */
    ...
    */
    ...
    /**
        ...
        \mlonly Implicitly used by [Pervasives.compare] for values of type [ast], [app], [sort], [func_decl], and [pattern]. \endmlonly
    */
    unsigned Z3_API Z3_get_ast_id(__in Z3_context c, Z3_ast t);

    /**
       \brief Return a hash code for the given AST.
       \mlonly Implicitly used by [Hashtbl.hash] for values of type [ast], [app], [sort], [func_decl], and [pattern]. \endmlonly
    */
    ...
    */
    ...
    /**
       ...
       \mlonly \remark [Z3.pattern_to_ast c p]  can be replaced by [(p :> Z3.ast)]. \endmlonly
    */
    ...
    */
    ...
    /**
       ...
       \remark For probes, "true" is any value different from 0.
    */
    ...
    */
    Z3_model_opt Z3_API Z3_solver_get_model(__in Z3_context c, __in Z3_solver s);
    ...
    */
    Z3_ast_opt Z3_API Z3_solver_get_proof(__in Z3_context c, __in Z3_solver s);
